...
import { Clock, Sparkles, ArrowLeft, CheckCircle2, RotateCcw, FileText } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-10 max-w-5xl mx-auto">
      <div className="relative flex flex-col items-center justify-center pt-2">
        ...
        <h1 className="text-2xl md:text-4xl font-extrabold text-[#DFD0B8] tracking-tight font-['Outfit'] text-center">Active Recall Sessions</h1>
      </div>
      ...
      <div className="flex items-center justify-between gap-4 bg-[#393E46]/50 p-4 md:p-5 rounded-2xl border border-[#948979]/20 shadow-md">
        ...
        <div className="flex items-center gap-3"><button type="button" className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#DFD0B8] text-[#222831] font-bold text-sm hover:bg-[#b3a898] transition-all shadow-lg shadow-[#DFD0B8]/10 hover:scale-[1.02]"><Sparkles className="w-4 h-4 text-[#222831]" /><span>Get Result</span></button></div>
      </div>
